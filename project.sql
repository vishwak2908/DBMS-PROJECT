...
VALUES (1, 'Soumya', 'soumya@gmail.com', 'guntur'), 

       (2, 'Vishwak', 'vishwak@gmail.com', 'hyderbad'), 

       (3, 'Srijan', 'srijan@gmail.com', 'Kakinada'), 

       (4,'Ashish','ashish@gmail.com','guntur'), 

       (5,'Vaibhav','vaibhav@gmail.com','guntur'); 
...
2. SELECT * FROM Customers WHERE Email = 'chinni@gmail.com'; 
...
4.SELECT * FROM Sales WHERE OrderID = 3; 

  

  

5.SELECT * FROM Inventory WHERE ProductID = 1; 
